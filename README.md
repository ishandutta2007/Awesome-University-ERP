...
|----------|-------------|---------|-----------------|----------------------------------|
| **[Oracle Student Cloud / PeopleSoft Campus Solutions](https://www.oracle.com/industries/higher-education/)** | Mature Campus Solutions and newer Oracle Cloud Student offerings for large public institutions and complex higher-education environments. | Custom Quote (Enterprise scale) | No free tier (Demo available) | $52B+ |
| **[Workday Student](https://www.workday.com/en-us/products/student.html)** | Cloud-native student system tightly integrated with Workday Finance and HCM, aimed at institutions seeking a unified enterprise platform. | Custom Quote (Enterprise scale) | No free tier (Demo available) | $7.3B+ |
| **[Ellucian Banner](https://www.ellucian.com/solutions/ellucian-banner)** | Flagship higher-education ERP and SIS for large universities, covering student, finance, HR, and financial aid with deep functional breadth and a large partner ecosystem. | Custom Quote (Enterprise scale) | No free tier (Demo available) | $1.2B+ |
| **[Ellucian Colleague](https://www.ellucian.com/solutions/ellucian-colleague)** | Integrated ERP/SIS designed for small-to-midsize colleges and community colleges, focusing on student lifecycle and administrative efficiency. | Custom Quote (Mid-to-Large scale) | No free tier (Demo available) | $1.2B+ |
| **[Anthology Student](https://www.anthology.com/)** | Modern student information and engagement platform (evolved from Campus Management and related products) supporting the full learner lifecycle. | Custom Quote (Mid-to-Large scale) | No free tier (Demo available) | $800M+ |
| **[CampusNexus](https://www.campusmanagement.com/)** | Student information and campus management solution historically focused on career colleges and specialized institutions (now part of broader Anthology ecosystem). | Custom Quote (Mid-to-Large scale) | No free tier (Demo available) | $800M+ |
| **[Unit4 Student Management](https://www.unit4.com/)** | People-centric ERP and student management solution popular in education and non-profit sectors, with strong fund accounting capabilities. | Custom Quote (Mid-to-Large scale) | No free tier (Demo available) | $400M+ |
| **[Jenzabar / Jenzabar ONE](https://www.jenzabar.com/)** | Higher-education platform tailored for small-to-midsize private colleges, combining SIS, CRM, retention tools, and administrative functions. | Custom Quote (Mid-scale) | No free tier (Demo available) | $150M+ |
...
| **[CAMS Enterprise](https://www.three-rivers.com/)** | Comprehensive student information system used by many private colleges and universities for academic and administrative operations. | Custom Quote (Mid-scale) | No free tier (Demo available) | $10M+ |
| **[Academia ERP](https://www.serosoft.com/)** | Higher-education ERP covering admissions, academics, examinations, finance, and campus administration. | Custom Quote (Mid-scale) | No free tier (Demo available) | $5M+ |
